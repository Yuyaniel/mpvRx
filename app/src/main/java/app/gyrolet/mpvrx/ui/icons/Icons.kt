...
object Icons {
  private object Shared {
    ...
    val StarBorder by lazy(LazyThreadSafetyMode.NONE) { AppIcon(StarBorderVector) }
  ...
  object RoundedFilled {
    ...
    val StarBorder get() = Shared.StarBorder
...
private val StarBorderVector: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
  ImageVector.Builder(
    name = "StarBorder",
    defaultWidth = 24.dp,
    defaultHeight = 24.dp,
